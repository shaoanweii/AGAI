...
export interface TaskEventItem extends MobileSingleEventListItem {
  ...
  /** 用户意图-一级#二级#三级#四级体验代码-标准观点（聚合展示文本） */
  intentionSummary?: string

  /** 处理人员（从 handlerSingleEventUserModel 中提取） */
  handlerName?: string
