  ...
  data: {
    ...
    [metric: string]: Record<
      string,
      {
        ...
        value1MoM: number | null
        value1YoY: number | null
        value2MoM: number | null
        value2YoY: number | null
      }
    >
  }
}
...
const processedBrands = computed(() => {
  ...
  // console.log('@@processedBrands',Array.from(brandMap.values()))
