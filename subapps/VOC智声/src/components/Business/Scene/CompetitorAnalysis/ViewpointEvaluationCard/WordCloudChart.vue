            ...
            <table style="width: 100%; border-collapse: collapse; margin: 0;">
              ...
              <tbody>
                <tr style="background: white;">
                  ...
                  <td style="padding: 8px 12px; text-align: center; color: #333; font-size: 14px;">${formatValue(data.mentionsMoM)}</td>
                  <td style="padding: 8px 12px; text-align: center; color: #333; font-size: 14px;">${formatValue(data.mentionsYoY)}</td>
                </tr>
              </tbody>
            </table>
          </div>
