 ...
 * @Version:1.0
 */
@LiteflowComponent(id = "complaintChannelMatchedEventNode", name = "处理渠道数据-投诉类")
public class ComplaintChannelMatchedEventNode extends NodeComponent {
    public static final DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss", Locale.CHINA);
    private static final Logger log = LoggerFactory.getLogger(ComplaintChannelMatchedEventNode.class);
