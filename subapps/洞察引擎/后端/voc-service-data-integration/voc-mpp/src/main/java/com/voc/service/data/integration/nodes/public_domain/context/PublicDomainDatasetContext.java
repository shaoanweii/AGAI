package com.voc.service.data.integration.nodes.public_domain.context;
...
public class PublicDomainDatasetContext implements Serializable {
    String workId;
...
//    String channelId;
    ...
    @Builder.Default
    List<DataIntegrationRecordModel> publicDomainDataset = new ArrayList<>();
