...
public class CacheJsonMapper {
    private static final Logger logger = LoggerFactory.getLogger(CacheJsonMapper.class);
    /**
     * 原生jackson mapper
     */
    private ObjectMapper mapper;

    private CacheJsonMapper() {
...
//        mapper.registerModule(xssModule);
     ...
     * @return 实例对象
     */
    public static CacheJsonMapper getInstances() {
    ...
    private static class JsonMapperHolder {
        private static CacheJsonMapper jsonMapper = new CacheJsonMapper();
    }
}
