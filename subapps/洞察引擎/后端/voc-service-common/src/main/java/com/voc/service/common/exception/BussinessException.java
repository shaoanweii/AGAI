...
public class BussinessException extends RuntimeException {
    ...
    public BussinessException(ErrorCode errorCode, Object... args) {
        this.code = errorCode.getCode();
     ...
     * @param e         引起业务异常的异常
     */
    public BussinessException(ErrorCode errorCode, Throwable e) {
        super(e);
        this.code = errorCode.getCode();
        this.message = errorCode.getMessage();
    }
     ...
     * @param e         引起业务异常的异常
     */
    public BussinessException(ErrorCode errorCode, Throwable e, Object... args) {
        super(e);
        this.code = errorCode.getCode();
        this.message = MessageFormat.format(errorCode.getMessage(), args);
    }
