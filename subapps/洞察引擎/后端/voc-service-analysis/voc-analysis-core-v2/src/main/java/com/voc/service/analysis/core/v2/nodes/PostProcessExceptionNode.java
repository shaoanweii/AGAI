 ...
 * @Version:1.0
 */
@LiteflowComponent(id = "postProcessExceptionNode", name = "后置过滤异常处理节点")
public class PostProcessExceptionNode extends NodeComponent {

    private static final Logger log = LoggerFactory.getLogger(PostProcessExceptionNode.class);
    @Autowired
    ...
    public void process() throws RetryException {
        try {
            ...
            batchPushRecordV2Service.modifyStatus(context.getClientId(), context.getErrorIds(), "-1", "B");
