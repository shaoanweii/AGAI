 ...
 * @Version:1.0
 */
@LiteflowComponent(id = "notificationInsDataStatusNode", name = "通知洞察引擎状态变更节点")
public class NotificationInsDataStatusNode extends AbstractNode {

    private static final Logger log = LoggerFactory.getLogger(NotificationInsDataStatusNode.class);
    @Autowired
    ...
    public void process()  {
        ...
        try {
            ...
            List<AysBatchPushRecordGroupByModel> recordGroupByList = iAysBatchPushRecordV2Service.findGroupByRequestId(clientId,context.getWorkId());
