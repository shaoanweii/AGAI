...
@NoArgsConstructor
@AllArgsConstructor
public class AysAnalFlowModelTagsResultDataExtModel implements Serializable {
    ...
    private String highQuality; // 注：DDL 注释有误，实际为高质量标识
    ...
    private LocalDateTime insertDt; // 数据库 DEFAULT CURRENT_TIMESTAMP
