...
public class VocAnalysisRiskApplication {

    private static final Logger log = LoggerFactory.getLogger(VocAnalysisRiskApplication.class);

    public static void main(String[] args) throws IOException {
        SpringApplication startupSpringApplication
                = new SpringApplication(VocAnalysisRiskApplication.class);
        ...
        log.info("--->> biz:{} added", VocAnalysisRiskApplication.class.getSimpleName());
        log.info("\n----------------------------------------------------------\n\t" +
