...
@NoArgsConstructor
@AllArgsConstructor
public class TagLibClientQYTemplateVo implements Serializable {
    /**
     * 标签类型
     */
     ...
     * 末级标签
     */
    @ExcelProperty(value = "末级标签", order = 5)
    @ColumnWidth(20)
    private String finalTag;
    /**
     * 标签定义
     */
    @ExcelProperty(value = "标签定义", order = 6)
    @ColumnWidth(20)
    private String tagDesc;
    /**
     * 能源分类
     */
    @ExcelProperty(value = "关联能源分类", order = 7)
    @ColumnWidth(20)
    private String energyCategory;
    /**
     * 车辆类型
     */
    @ExcelProperty(value = "关联车辆类型", order = 8)
    @ColumnWidth(20)
    private String carType;
    @Schema(description = "严重性")
    @ExcelProperty(value = "严重性等级", order = 9)
    @ColumnWidth(20)
    private String seriousness;
    @Schema(description = "用户旅途")
    @ExcelProperty(value = "关联用户旅程", order = 10)
    @ColumnWidth(20)
