...
public class SM4DecryptUtil {
    ...
    public static void main(String[] args) {
        // 测试用Base64加密串（替换为实际需要解密的mobile值）
        String testBase64Mobile = "王小明QJ59shcQ==";

        boolean validBase64 = isValidBase64(testBase64Mobile);
        if (validBase64) {
            // 解密
            String plainMobile = decryptMobile(testBase64Mobile);

            if (plainMobile != null) {
                System.out.println("解密后的手机号：" + plainMobile);
            } else {
