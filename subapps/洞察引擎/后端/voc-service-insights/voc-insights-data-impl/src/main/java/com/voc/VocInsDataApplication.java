...
@EnableScheduling
public class VocInsDataApplication {

    private static final Logger log = LoggerFactory.getLogger(VocInsDataApplication.class);

    public static void main(String[] args) throws IOException {
        SpringApplication startupSpringApplication
                = new SpringApplication(VocInsDataApplication.class);
        ...
        log.info("--->> biz:{} added", VocInsDataApplication.class.getSimpleName());
        log.info("\n----------------------------------------------------------\n\t" +
