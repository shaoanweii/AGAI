...
public class VocInsAlertImplApplication {

    private static final Logger log = LoggerFactory.getLogger(VocInsAlertImplApplication.class);

    public static void main(String[] args) throws IOException {
        SpringApplication startupSpringApplication
                = new SpringApplication(VocInsAlertImplApplication.class);
        ...
        log.info("--->> biz:{} added", VocInsAlertImplApplication.class.getSimpleName());
        log.info("\n----------------------------------------------------------\n\t" +
