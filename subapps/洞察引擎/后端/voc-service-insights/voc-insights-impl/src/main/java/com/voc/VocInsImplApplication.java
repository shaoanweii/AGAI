...
public class VocInsImplApplication {


    private static final Logger log = LoggerFactory.getLogger(VocInsImplApplication.class);

    public static void main(String[] args) throws IOException {
        SpringApplication startupSpringApplication
                = new SpringApplication(VocInsImplApplication.class);
        ...
        log.info("--->> biz:{} added", VocInsImplApplication.class.getSimpleName());
        log.info("\n----------------------------------------------------------\n\t" +
