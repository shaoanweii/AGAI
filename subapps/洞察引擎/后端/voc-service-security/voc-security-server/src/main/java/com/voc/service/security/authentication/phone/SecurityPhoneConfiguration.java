...
public class SecurityPhoneConfiguration extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {
    ...
    @Autowired
    PhoneAuthenticationHandler authenticationHandler;
    @Autowired
    ...
    public void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        PhoneLoginFilter filter = new PhoneLoginFilter(httpSecurity.getSharedObject(AuthenticationManager.class), authenticationHandler);
