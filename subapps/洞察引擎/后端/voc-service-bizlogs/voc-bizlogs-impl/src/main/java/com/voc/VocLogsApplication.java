...
public class VocLogsApplication {
    private static final Logger logger = LoggerFactory.getLogger(VocLogsApplication.class);
    public static void main(String[] args) throws IOException {
        SpringApplication startupSpringApplication
                = new SpringApplication(VocLogsApplication.class);
        ...
        logger.info("--->> biz:{} added", VocLogsApplication.class.getSimpleName());
        logger.info("\n----------------------------------------------------------\n\t" +
