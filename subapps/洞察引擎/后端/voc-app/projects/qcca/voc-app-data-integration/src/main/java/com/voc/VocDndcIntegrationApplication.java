...
public class VocDndcIntegrationApplication {

    private static final Logger log = LoggerFactory.getLogger(VocDndcIntegrationApplication.class);

    public static void main(String[] args) throws IOException {

        SpringApplication startupSpringApplication
                = new SpringApplication(VocDndcIntegrationApplication.class);
        ...
        log.info("--->> biz:{} added", VocDndcIntegrationApplication.class.getSimpleName());
        log.info("\n----------------------------------------------------------\n\t" +
