...
public class VocInsightsApplication {
    private static final Logger logger = LoggerFactory.getLogger(VocInsightsApplication.class);
    public static void main(String[] args) throws IOException {
        ...
        logger.info("--->> biz:{} added", VocInsightsApplication.class.getSimpleName());
        logger.info("\n----------------------------------------------------------\n\t" +
