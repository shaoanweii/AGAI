...
public class VocRiskApplication {
    private static final Logger logger = LoggerFactory.getLogger(VocRiskApplication.class);
    public static void main(String[] args) throws IOException {

        SpringApplication startupSpringApplication
                = new SpringApplication(VocRiskApplication.class);
        ...
        logger.info("--->> biz:{} added", VocRiskApplication.class.getSimpleName());
        logger.info("\n----------------------------------------------------------\n\t" +
