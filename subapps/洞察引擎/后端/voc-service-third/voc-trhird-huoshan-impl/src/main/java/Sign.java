...
public class Sign {
    ...
    public static void main(String[] args) throws Exception {
        String SecretAccessKey = "TURBNU5ETTJNVGc1TkdWaU5HWTNOemd3WWpsak4ySmtZMlV6T1RVd01qTQ==";
        String AccessKeyID = "AKLTMDQ5YzlmMjA0NTYyNDUxMmIzODFjMmQwMDk2MzhhNzI";
        // 请求地址
...
//        String xDate = sdf.format(DateUtil.offsetDay(date, 1));
