import { createSeedData } from './voc-demo-seed.mjs'

const createDemoPdfDataUrl = () => 'data:application/pdf;base64,JVBERi0xLjQKJSVFT0Y='
...
export const buildResult = (pathname, method, body, database) => {
  const value = pathname.toLowerCase()
